...
<head>
    ...
    <style>
        /* Global styles (for clients that support it) */
        body {
                    ...
                    <tr>
                        <td style="padding: 24px;" class="content-area">
                            ...
                            <p style="font-size: 14px; line-height: 1.6; margin: 0 0 24px 0;">
                                A system administrator has initiated a password reset for your account. Please click the button below to set a new password securely:
                            </p>

                            <!-- CRITICAL FIX: Button as a single anchor tag in its own paragraph/table -->
                            <table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto 30px auto;">
                                <tr>
                                    <td align="center" bgcolor="<?php echo $maroon; ?>" style="border-radius: 6px;">
                                        <!-- Inside the button table, the link MUST look like this: -->
                                        <a href="<?php echo htmlspecialchars($link, ENT_QUOTES, 'UTF-8'); ?>" target="_blank"
                                            style="display: block; padding: 12px 25px; border-radius: 6px; background-color: #7b1e28; color: #ffffff; 
                            ...
                            <p style="font-size: 12px; color: #555555; margin: 0 0 5px 0;">
                                If the button above does not work, copy and paste this link into your browser:
                            </p>
                            <!-- Fallback Link (Gagamitin ang $link) -->
                            <p style="font-size: 12px; color: <?php echo $maroon; ?>; word-break: break-all; margin: 0;">
                                <a href="<?php echo htmlspecialchars($link, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" style="color: <?php echo $maroon; ?>; text-decoration: underline;">
