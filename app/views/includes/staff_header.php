...
if (($_SESSION['user']['role'] ?? '') !== 'staff') { header('Location: ' . URLROOT . '/errors/403'); exit; }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <!-- Bootstrap + FontAwesome (CDN gaya ng admin) -->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">

  <!-- FullCalendar (kailangan bago ang staff.js) -->
  <script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.13/index.global.min.js"></script>

  <!-- Reuse ng admin styles (theme, etc.) -->
  <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/staff.css?v=<?php echo time(); ?>">
  <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/staff_theme.css?v=<?php echo time(); ?>">
  ...
  <style>
    ...
    .top-navbar-right .dropdown-menu{
      right:0; left:auto; min-width:320px; max-width:360px; z-index:2000;
      background:#fff; color:#212529; border:1px solid rgba(0,0,0,.1); box-shadow:0 6px 24px rgba(0,0,0,.12);
    }
...
<body data-must-change-pwd="<?php echo htmlspecialchars($_SESSION['user']['must_change_pwd'] ?? '0'); ?>">
  ...
  <nav class="top-navbar">
    ...
    <div class="top-navbar-right">
      <!-- 🔔 Notifications dropdown (same IDs para gumana notifications.js) -->
      <div class="dropdown" id="notifRoot">
        ...
        <!-- Ililipat ito ng JS sa <body> para hindi ma-clip -->
  ...
  <div class="main-wrapper">
    <aside id="sidebar">
      ...
      <div class="sidebar-footer">
        <ul class="sidebar-nav">
          <li>
            <a href="<?php echo URLROOT; ?>/staff/profile"
    ...
    <main class="main-content">
      <div class="container-fluid p-4">
        ...
        <!-- Footer spacing sync (same script as admin) -->
        <script>
          (function () {
