  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn text-white" style="background-color: var(--maroon);" id="edit-save-btn">Save Changes</button>
      </div>
    </div>
  </div>
</div>

<script src="<?php echo URLROOT; ?>/js/staff_profile.js?v=<?php echo time(); ?>"></script>
