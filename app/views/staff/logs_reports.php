<?php require APPROOT . '/views/includes/staff_header.php'; // Using the same header as staff ?>
...
<?php require APPROOT . '/views/includes/staff_footer.php'; // Using the same footer as staff ?>